...
import { useGetSingleEventsCategoryDescriptionQuery } from "../../Redux/features/eventsCategoryDescription/eventsCategoryDescriptionApi";

const NewsDetails = () => {
  const { id } = useParams();

  const { data, isLoading, isError, error } =
    useGetSingleEventsCategoryDescriptionQuery(id);
