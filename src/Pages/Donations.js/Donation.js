      ...
      <div className="row">
        ...
        <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
          <div className="causes-one__single">
            ...
            <div className="causes-one__content">
              <h3 className="causes-one__title"><a href="donation-details.html">Let’s education for
        ...
        <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
          <div className="causes-one__single">
            ...
            <div className="causes-one__content">
              <h3 className="causes-one__title"><a href="donation-details.html">It is a long established
        ...
        <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
          <div className="causes-one__single">
            ...
            <div className="causes-one__content">
              <h3 className="causes-one__title"><a href="donation-details.html">There are many variations
                  of passages</a>
              </h3>
              <p className="causes-one__text">There are many of lorem, but majori have
                suffered alteration in some form.</p>
        ...
        <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
          <div className="causes-one__single">
            ...
            <div className="causes-one__content">
              <h3 className="causes-one__title"><a href="donation-details.html">Maecenas ut ligula ut nisi
                  porta tempor ac</a>
              </h3>
              <p className="causes-one__text">There are many of lorem, but majori have
                suffered alteration in some form.</p>
        ...
        <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="500ms">
          <div className="causes-one__single">
            ...
            <div className="causes-one__content">
              <h3 className="causes-one__title"><a href="donation-details.html">Phasellus suscipit est
        ...
        <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="600ms">
          <div className="causes-one__single">
            ...
            <div className="causes-one__content">
              <h3 className="causes-one__title"><a href="donation-details.html">Sed malesuada nisl eget
                  porta luctus</a>
              </h3>
              <p className="causes-one__text">There are many of lorem, but majori have
                suffered alteration in some form.</p>
